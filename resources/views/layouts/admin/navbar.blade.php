    ...
    <div class="nav-collapse">
      <ul class="nav">
        ...
        <li class="dropdown"><a data-toggle="dropdown" href="#">
          <span aria-hidden="true" class="se7en-star"></span>Master Entries<b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li>
              <a href="buttons.html">Category</a>
            </li>
            <li>
              <a href="fontawesome.html">Color</a>
            </li>
            
            <li>
              <a href="components.html">Fabric Material</a>
            </li>
            <li>
              <a href="widgets.html">Wash Care</a>
            </li>
          </ul>
        </li>
        <li class="dropdown"><a data-toggle="dropdown" href="#">
